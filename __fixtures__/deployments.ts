...
export const deploymentsForRef = [
  {
    url:
      'https://api.github.com/repos/patricksimonian/strapi-demo/deployments/4',
    id: 12,
    ...
    creator: {
      ...
      followers_url:
        'https://api.github.com/users/digital-gov-bc-ca-cicd-dev%5Bbot%5D/followers',
      following_url:
        'https://api.github.com/users/digital-gov-bc-ca-cicd-dev%5Bbot%5D/following{/other_user}',
      gists_url:
        'https://api.github.com/users/digital-gov-bc-ca-cicd-dev%5Bbot%5D/gists{/gist_id}',
      starred_url:
        'https://api.github.com/users/digital-gov-bc-ca-cicd-dev%5Bbot%5D/starred{/owner}{/repo}',
      subscriptions_url:
        'https://api.github.com/users/digital-gov-bc-ca-cicd-dev%5Bbot%5D/subscriptions',
      organizations_url:
        'https://api.github.com/users/digital-gov-bc-ca-cicd-dev%5Bbot%5D/orgs',
      repos_url:
        'https://api.github.com/users/digital-gov-bc-ca-cicd-dev%5Bbot%5D/repos',
      events_url:
        'https://api.github.com/users/digital-gov-bc-ca-cicd-dev%5Bbot%5D/events{/privacy}',
      received_events_url:
        'https://api.github.com/users/digital-gov-bc-ca-cicd-dev%5Bbot%5D/received_events',
      type: 'Bot',
      site_admin: false,
    },
    ...
    statuses_url:
      'https://api.github.com/repos/patricksimonian/strapi-demo/deployments/259531684/statuses',
...
export const deploymentStatusForDeploymentWhereAllSuccessful = [
  {
    url:
      'https://api.github.com/repos/bcgov/devhub-app-web/deployments/123/statuses/23434',
    id: 1312,
    ...
    deployment_url:
      'https://api.github.com/repos/bcgov/devhub-app-web/deployments/3434',
    repository_url: 'https://api.github.com/repos/bcgov/devhub-app-web',
    performed_via_github_app: null,
  },
  {
    url:
      'https://api.github.com/repos/bcgov/devhub-app-web/deployments/3434/statuses/34434',
    id: 34434,
    ...
    deployment_url:
      'https://api.github.com/repos/bcgov/devhub-app-web/deployments/343',
    repository_url: 'https://api.github.com/repos/bcgov/devhub-app-web',
    performed_via_github_app: null,
  },
];
